...
export function Topnav() {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-8 bg-transparent z-50 relative border-b border-border/30">
      <div className="flex-1 flex items-center gap-4">
        <div className="relative w-96">
          ...
          <input 
            type="text" 
            placeholder="Search cases, threat actors, evidence... (Press Enter)" 
